---
title: "Examen"
author: "Sarah Camila Guzmán Fierro - A01639368"
format:
   html:
     mathjax: true
     toc: true
...
```{r}
cpquery(bn, event= (S == "Female" & A == "18-50" & M =="Hate"), evidence= ((L == "South") & (R == "Partner")), n= 10^6)
```
...
$$\mathbb{P}(\text{ [S = "Female" } \cap \text{ A = "18-50" ]} \cap \text{ M = "Hate" ]}\mid [ \text{R = "Partner"}  \cap \text{L = "South"} ] )$$
es de 0.1839 ó 18.39%